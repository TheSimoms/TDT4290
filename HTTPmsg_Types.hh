...
boolean match(strict__crlf__mode::enum_type other_value) const;
boolean match(const strict__crlf__mode& other_value) const;
strict__crlf__mode::enum_type valueof() const;
void set_type(template_sel template_type, unsigned int list_length);
strict__crlf__mode_template& list_item(unsigned int list_index);
void log() const;
void log_match(const strict__crlf__mode& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
...
boolean match(const HeaderLine& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const HeaderLine& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const HeaderLines& other_value) const;
...
void log() const;
void log_match(const HeaderLines& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
boolean is_present() const;
boolean match_omit() const;
...
boolean match(const HTTPResponse& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const HTTPResponse& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const HTTPRequest& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const HTTPRequest& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const HTTPResponse__binary__body& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const HTTPResponse__binary__body& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const HTTPRequest__binary__body& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const HTTPRequest__binary__body& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const HTTP__erronous__msg& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const HTTP__erronous__msg& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const HTTPMessage& other_value) const;
...
void log() const;
void log_match(const HTTPMessage& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
boolean is_present() const;
boolean match_omit() const;
...
boolean match(const Close& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
Close valueof() const;
...
int size_of() const;
void log() const;
void log_match(const Close& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const Connect& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const Connect& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const Connect__result& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const Connect__result& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const Client__connected& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const Client__connected& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const Half__close& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const Half__close& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const Listen& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const Listen& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const Listen__result& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const Listen__result& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const Shutdown& other_value) const;
Shutdown valueof() const;
void set_type(template_sel template_type, unsigned int list_length);
Shutdown_template& list_item(unsigned int list_index) const;
void log() const;
void log_match(const Shutdown& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(const Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
