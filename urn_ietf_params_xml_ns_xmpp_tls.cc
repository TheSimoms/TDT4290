...
const XERdescriptor_t       Starttls_choice_xer_ = { {"choice>\n", "choice>\n"}, {8, 8}, 0 |UNTAGGED, WHITESPACE_PRESERVE,  NULL, &module_object, 11, 0, NULL, NULL };
...
const XERdescriptor_t       Proceed_xer_ = { {"Proceed>\n", "proceed>\n"}, {9, 9}, 0, WHITESPACE_PRESERVE,  NULL, &module_object, 11, 0, NULL, NULL };
...
static const namespace_t xml_namespaces[num_namespaces+1] = {
  ...
  { NULL, NULL },
  { NULL, NULL },
  { "urn:ietf:params:xml:ns:xmpp-tls", "tq0008" },
  { NULL, NULL },
  { NULL, NULL },
  { NULL, NULL },
  { NULL, NULL },
