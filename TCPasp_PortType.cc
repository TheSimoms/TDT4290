...
TTCN_Module module_object("TCPasp_PortType", __DATE__, __TIME__, module_checksum, pre_init_module, NULL, 0U, 4294967295U, 4294967295U, 4294967295U, NULL, 21LU, xml_namespaces, post_init_module, NULL, NULL, NULL, NULL, NULL);
...
void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Connect& send_par, const COMPONENT& destination_component)
{
...
void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Connect& send_par)
{
send(send_par, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Connect_template& send_par, const COMPONENT& destination_component)
{
...
void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Connect_template& send_par)
{
const TCPasp__Types::ASP__TCP__Connect& send_par_value = TCPasp__Types::ASP__TCP__Connect(send_par.valueof());
send(send_par_value, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Listen& send_par, const COMPONENT& destination_component)
{
if (!is_started) TTCN_error("Sending a message on port %s, which is not started.", port_name);
if (!destination_component.is_bound()) TTCN_error("Unbound component reference in the to clause of send operation.");
const TTCN_Logger::Severity log_sev = destination_component==SYSTEM_COMPREF?TTCN_Logger::PORTEVENT_MMSEND:TTCN_Logger::PORTEVENT_MCSEND;
...
void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Listen& send_par)
{
send(send_par, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Listen_template& send_par, const COMPONENT& destination_component)
{
const TCPasp__Types::ASP__TCP__Listen& send_par_value = TCPasp__Types::ASP__TCP__Listen(send_par.valueof());
send(send_par_value, destination_component);
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Listen_template& send_par)
{
const TCPasp__Types::ASP__TCP__Listen& send_par_value = TCPasp__Types::ASP__TCP__Listen(send_par.valueof());
send(send_par_value, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Shutdown& send_par, const COMPONENT& destination_component)
{
if (!is_started) TTCN_error("Sending a message on port %s, which is not started.", port_name);
if (!destination_component.is_bound()) TTCN_error("Unbound component reference in the to clause of send operation.");
const TTCN_Logger::Severity log_sev = destination_component==SYSTEM_COMPREF?TTCN_Logger::PORTEVENT_MMSEND:TTCN_Logger::PORTEVENT_MCSEND;
...
void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Shutdown& send_par)
{
send(send_par, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Shutdown_template& send_par, const COMPONENT& destination_component)
{
const TCPasp__Types::ASP__TCP__Shutdown& send_par_value = TCPasp__Types::ASP__TCP__Shutdown(send_par.valueof());
send(send_par_value, destination_component);
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Shutdown_template& send_par)
{
const TCPasp__Types::ASP__TCP__Shutdown& send_par_value = TCPasp__Types::ASP__TCP__Shutdown(send_par.valueof());
send(send_par_value, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const CHARSTRING& send_par, const COMPONENT& destination_component)
{
if (!is_started) TTCN_error("Sending a message on port %s, which is not started.", port_name);
if (!destination_component.is_bound()) TTCN_error("Unbound component reference in the to clause of send operation.");
const TTCN_Logger::Severity log_sev = destination_component==SYSTEM_COMPREF?TTCN_Logger::PORTEVENT_MMSEND:TTCN_Logger::PORTEVENT_MCSEND;
...
void TCPasp__PT::send(const CHARSTRING& send_par)
{
send(send_par, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const CHARSTRING_template& send_par, const COMPONENT& destination_component)
{
const CHARSTRING& send_par_value = CHARSTRING(send_par.valueof());
send(send_par_value, destination_component);
}

void TCPasp__PT::send(const CHARSTRING_template& send_par)
{
const CHARSTRING& send_par_value = CHARSTRING(send_par.valueof());
send(send_par_value, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP& send_par, const COMPONENT& destination_component)
{
if (!is_started) TTCN_error("Sending a message on port %s, which is not started.", port_name);
if (!destination_component.is_bound()) TTCN_error("Unbound component reference in the to clause of send operation.");
const TTCN_Logger::Severity log_sev = destination_component==SYSTEM_COMPREF?TTCN_Logger::PORTEVENT_MMSEND:TTCN_Logger::PORTEVENT_MCSEND;
...
void TCPasp__PT::send(const TCPasp__Types::ASP__TCP& send_par)
{
send(send_par, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP_template& send_par, const COMPONENT& destination_component)
{
const TCPasp__Types::ASP__TCP& send_par_value = TCPasp__Types::ASP__TCP(send_par.valueof());
send(send_par_value, destination_component);
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP_template& send_par)
{
const TCPasp__Types::ASP__TCP& send_par_value = TCPasp__Types::ASP__TCP(send_par.valueof());
send(send_par_value, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Close& send_par, const COMPONENT& destination_component)
{
if (!is_started) TTCN_error("Sending a message on port %s, which is not started.", port_name);
if (!destination_component.is_bound()) TTCN_error("Unbound component reference in the to clause of send operation.");
const TTCN_Logger::Severity log_sev = destination_component==SYSTEM_COMPREF?TTCN_Logger::PORTEVENT_MMSEND:TTCN_Logger::PORTEVENT_MCSEND;
...
void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Close& send_par)
{
send(send_par, COMPONENT(get_default_destination()));
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Close_template& send_par, const COMPONENT& destination_component)
{
const TCPasp__Types::ASP__TCP__Close& send_par_value = TCPasp__Types::ASP__TCP__Close(send_par.valueof());
send(send_par_value, destination_component);
}

void TCPasp__PT::send(const TCPasp__Types::ASP__TCP__Close_template& send_par)
{
const TCPasp__Types::ASP__TCP__Close& send_par_value = TCPasp__Types::ASP__TCP__Close(send_par.valueof());
send(send_par_value, COMPONENT(get_default_destination()));
}

alt_status TCPasp__PT::receive(const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
...
alt_status TCPasp__PT::check_receive(const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::trigger(const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::receive(const TCPasp__Types::ASP__TCP__Connect__result_template& value_template, TCPasp__Types::ASP__TCP__Connect__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::check_receive(const TCPasp__Types::ASP__TCP__Connect__result_template& value_template, TCPasp__Types::ASP__TCP__Connect__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::trigger(const TCPasp__Types::ASP__TCP__Connect__result_template& value_template, TCPasp__Types::ASP__TCP__Connect__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::receive(const TCPasp__Types::ASP__TCP__Connected_template& value_template, TCPasp__Types::ASP__TCP__Connected *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::check_receive(const TCPasp__Types::ASP__TCP__Connected_template& value_template, TCPasp__Types::ASP__TCP__Connected *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::trigger(const TCPasp__Types::ASP__TCP__Connected_template& value_template, TCPasp__Types::ASP__TCP__Connected *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::receive(const TCPasp__Types::ASP__TCP__Listen__result_template& value_template, TCPasp__Types::ASP__TCP__Listen__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::check_receive(const TCPasp__Types::ASP__TCP__Listen__result_template& value_template, TCPasp__Types::ASP__TCP__Listen__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::trigger(const TCPasp__Types::ASP__TCP__Listen__result_template& value_template, TCPasp__Types::ASP__TCP__Listen__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::receive(const TCPasp__Types::ASP__TCP__Send__error_template& value_template, TCPasp__Types::ASP__TCP__Send__error *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::check_receive(const TCPasp__Types::ASP__TCP__Send__error_template& value_template, TCPasp__Types::ASP__TCP__Send__error *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::trigger(const TCPasp__Types::ASP__TCP__Send__error_template& value_template, TCPasp__Types::ASP__TCP__Send__error *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::receive(const TCPasp__Types::ASP__TCP_template& value_template, TCPasp__Types::ASP__TCP *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::check_receive(const TCPasp__Types::ASP__TCP_template& value_template, TCPasp__Types::ASP__TCP *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::trigger(const TCPasp__Types::ASP__TCP_template& value_template, TCPasp__Types::ASP__TCP *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::receive(const TCPasp__Types::ASP__TCP__Close_template& value_template, TCPasp__Types::ASP__TCP__Close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::check_receive(const TCPasp__Types::ASP__TCP__Close_template& value_template, TCPasp__Types::ASP__TCP__Close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status TCPasp__PT::trigger(const TCPasp__Types::ASP__TCP__Close_template& value_template, TCPasp__Types::ASP__TCP__Close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
