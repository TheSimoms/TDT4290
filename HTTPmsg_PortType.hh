...
alt_status receive(const HTTPmsg__Types::Connect__result_template& value_template, HTTPmsg__Types::Connect__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status check_receive(const HTTPmsg__Types::Connect__result_template& value_template, HTTPmsg__Types::Connect__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status trigger(const HTTPmsg__Types::Connect__result_template& value_template, HTTPmsg__Types::Connect__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status receive(const HTTPmsg__Types::Client__connected_template& value_template, HTTPmsg__Types::Client__connected *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status check_receive(const HTTPmsg__Types::Client__connected_template& value_template, HTTPmsg__Types::Client__connected *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status trigger(const HTTPmsg__Types::Client__connected_template& value_template, HTTPmsg__Types::Client__connected *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status receive(const HTTPmsg__Types::Listen__result_template& value_template, HTTPmsg__Types::Listen__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status check_receive(const HTTPmsg__Types::Listen__result_template& value_template, HTTPmsg__Types::Listen__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status trigger(const HTTPmsg__Types::Listen__result_template& value_template, HTTPmsg__Types::Listen__result *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status receive(const HTTPmsg__Types::Close_template& value_template, HTTPmsg__Types::Close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status check_receive(const HTTPmsg__Types::Close_template& value_template, HTTPmsg__Types::Close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status trigger(const HTTPmsg__Types::Close_template& value_template, HTTPmsg__Types::Close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status receive(const HTTPmsg__Types::Half__close_template& value_template, HTTPmsg__Types::Half__close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status check_receive(const HTTPmsg__Types::Half__close_template& value_template, HTTPmsg__Types::Half__close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status trigger(const HTTPmsg__Types::Half__close_template& value_template, HTTPmsg__Types::Half__close *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status receive(const HTTPmsg__Types::Shutdown_template& value_template, HTTPmsg__Types::Shutdown *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status check_receive(const HTTPmsg__Types::Shutdown_template& value_template, HTTPmsg__Types::Shutdown *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status trigger(const HTTPmsg__Types::Shutdown_template& value_template, HTTPmsg__Types::Shutdown *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status receive(const HTTPmsg__Types::HTTPMessage_template& value_template, HTTPmsg__Types::HTTPMessage *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status check_receive(const HTTPmsg__Types::HTTPMessage_template& value_template, HTTPmsg__Types::HTTPMessage *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status trigger(const HTTPmsg__Types::HTTPMessage_template& value_template, HTTPmsg__Types::HTTPMessage *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
private:
