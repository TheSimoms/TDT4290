...
#ifndef jabber__client_HH
#define jabber__client_HH
...
public:
  Message();
  Message(const OPTIONAL<UNIVERSAL_CHARSTRING>& par_from__,
...
public:
  Presence();
  Presence(const OPTIONAL<UNIVERSAL_CHARSTRING>& par_from__,
    const OPTIONAL<UNIVERSAL_CHARSTRING>& par_id,
    const OPTIONAL<CHARSTRING>& par_lang,
    const OPTIONAL<UNIVERSAL_CHARSTRING>& par_to__,
...
public:
  Iq();
  Iq(const OPTIONAL<UNIVERSAL_CHARSTRING>& par_from__,
