...
const XERdescriptor_t       Lang_xer_ = { {"Lang>\n", "lang>\n"}, {6, 6}, 0 |XER_ATTRIBUTE |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, 7, 0, NULL, NULL };
...
Space Space_dfe;
const XERdescriptor_t       Space_xer_ = { {"Space>\n", "space>\n"}, {7, 7}, 0 |XER_ATTRIBUTE |FORM_UNQUALIFIED, WHITESPACE_PRESERVE, &Space_dfe, &module_object, 7, 0, NULL, NULL };
...
static const namespace_t xml_namespaces[num_namespaces+1] = {
  ...
  { NULL, NULL },
  { NULL, NULL },
  { "http://www.w3.org/XML/1998/namespace", "tq0004" },
  { NULL, NULL },
  { NULL, NULL },
  { NULL, NULL },
  { NULL, NULL },
