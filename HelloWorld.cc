...
// for user (user@user-multicom) on Wed Sep 16 15:23:06 2015
...
cs_0(13, "Hello, world!");
static const unsigned char module_checksum[] = { 0x09, 0x40, 0x83, 0xd1, 0x3b, 0x30, 0xf0, 0x55, 0xff, 0x59, 0x4d, 0xa3, 0x9e, 0xc6, 0xa6, 0x5f };
...
TTCN_Module module_object("HelloWorld", __DATE__, __TIME__, module_checksum, pre_init_module, NULL, 0U, 4294967295U, 4294967295U, 4294967295U, NULL, 21LU, xml_namespaces, NULL, NULL, NULL, init_comp_type, NULL, module_control_part);
...
try {
TTCN_Runtime::begin_testcase("HelloWorld", "HelloW", "HelloWorld", "MTCType", "HelloWorld", "MTCType", has_timer, timer_value);
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 23 */
TTCN_Runtime::map_port(MTC_COMPREF, MTCType_component_MyPCO.get_name(), SYSTEM_COMPREF, MTCType_component_MyPCO.get_name());
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 24 */
MTCType_component_MyPCO.send(cs_0);
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 25 */
...
TTCN_Runtime::check_begin_testcase(has_timer, timer_value);
try {
TTCN_Runtime::begin_testcase("HelloWorld", "HelloW2", "HelloWorld", "MTCType", "HelloWorld", "MTCType", has_timer, timer_value);
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 30 */
TIMER T("T", 1.0);
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 31 */
TTCN_Runtime::map_port(MTC_COMPREF, MTCType_component_MyPCO.get_name(), SYSTEM_COMPREF, MTCType_component_MyPCO.get_name());
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 32 */
MTCType_component_MyPCO.send(cs_0);
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 33 */
T.start();
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 34 */
{
tmp_0:
...
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 35 */
...
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 36 */
...
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 37 */
...
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 34 */
if (tmp_0_alt_flag_0 == ALT_NO && tmp_0_alt_flag_1 == ALT_NO && tmp_0_alt_flag_2 == ALT_NO && tmp_0_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn between lines 34 and 38.");
...
static void module_control_part()
{
TTCN_Runtime::begin_controlpart("HelloWorld");
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 43 */
testcase_HelloW(FALSE, 0.0);
/* /work/TDT4290/src/testcases/hello_world/HelloWorld.ttcn, line 44 */
