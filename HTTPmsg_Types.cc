...
// for user (user@user-multicom) on Fri Oct  9 13:20:29 2015
...
static const unsigned char module_checksum[] = { 0x85, 0xa1, 0xc4, 0x8a, 0x66, 0x7f, 0xdf, 0xba, 0x07, 0xfb, 0x31, 0x43, 0x97, 0x7f, 0x2e, 0x31 };
...
TTCN_Module module_object("HTTPmsg_Types", __DATE__, __TIME__, module_checksum, pre_init_module, NULL, 0U, 4294967295U, 4294967295U, 4294967295U, NULL, 21LU, xml_namespaces, post_init_module, set_module_param, log_module_param, NULL, NULL, NULL);
...
boolean strict__crlf__mode_template::match(strict__crlf__mode::enum_type other_value) const
{
switch (template_selection) {
case SPECIFIC_VALUE:
...
boolean strict__crlf__mode_template::match(const strict__crlf__mode& other_value) const
{
...
void strict__crlf__mode_template::log_match(const strict__crlf__mode& match_value) const
{
match_value.log();
...
boolean strict__crlf__mode_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean strict__crlf__mode_template::match_omit() const
{
...
void strict__crlf__mode_template::set_param(Module_Param& param)
{
  ...
  case Module_Param::MP_Enumerated: {
    strict__crlf__mode::enum_type enum_val = strict__crlf__mode::str_to_enum(param.get_enumerated());
...
void strict__crlf__mode_template::check_restriction(template_res t_res, const char* t_name) const
{
...
int HeaderLine::size_of() const
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.HeaderLine");
  return 2;
}
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.HeaderLine'");
    }
    if (strcmp("header_name", param_field) == 0) {
      header__name().set_param(param);
      return;
    } else if (strcmp("header_value", param_field) == 0) {
      header__value().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.HeaderLine'", param_field);
  }
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.HeaderLine.");
...
boolean HeaderLine_template::match(const HeaderLine& other_value) const
{
...
if(!single_value->field_header__name.match(other_value.header__name()))return FALSE;
if(!other_value.header__value().is_bound()) return FALSE;
if(!single_value->field_header__value.match(other_value.header__value()))return FALSE;
return TRUE;
case VALUE_LIST:
case COMPLEMENTED_LIST:
for (unsigned int list_count = 0; list_count < value_list.n_values; list_count++)
...
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.HeaderLine.");
HeaderLine ret_val;
...
void HeaderLine_template::log_match(const HeaderLine& match_value) const
{
...
if(!single_value->field_header__name.match(match_value.header__name())){
TTCN_Logger::log_logmatch_info(".header_name");
single_value->field_header__name.log_match(match_value.header__name());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
if(!single_value->field_header__value.match(match_value.header__value())){
TTCN_Logger::log_logmatch_info(".header_value");
single_value->field_header__value.log_match(match_value.header__value());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
}else {
TTCN_Logger::print_logmatch_buffer();
...
void HeaderLine_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.HeaderLine'");
    }
    if (strcmp("header_name", param_field) == 0) {
      header__name().set_param(param);
      return;
      ...
      header__value().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.HeaderLine'", param_field);
  }
...
void HeaderLine_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean HeaderLine_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean HeaderLine_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] < '0' || param_field[0] > '9') {
      param.error("Unexpected record field name in module parameter, expected a valid"
        " index for record of type `@HTTPmsg_Types.HeaderLines'");
    }
    int param_index = -1;
...
boolean HeaderLines_template::match_function_specific(const Base_Type *value_ptr, int value_index, const Restricted_Length_Template *template_ptr, int template_index)
{
if (value_index >= 0) return ((const HeaderLines_template*)template_ptr)->single_value.value_elements[template_index]->match((*(const HeaderLines*)value_ptr)[value_index]);
...
boolean HeaderLines_template::match(const HeaderLines& other_value) const
{
if (!other_value.is_bound()) return FALSE;
...
void HeaderLines_template::log_match(const HeaderLines& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
boolean HeaderLines_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean HeaderLines_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
void HeaderLines_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] < '0' || param_field[0] > '9') {
      param.error("Unexpected record field name in module parameter, expected a valid"
        " index for record template type `@HTTPmsg_Types.HeaderLines'");
    }
    int param_index = -1;
    sscanf(param_field, "%d", &param_index);
    (*this)[param_index].set_param(param);
...
void HeaderLines_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.HTTPResponse");
  int ret_val = 6;
...
void HTTPResponse::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.HTTPResponse'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
    } else if (strcmp("version_major", param_field) == 0) {
      version__major().set_param(param);
      return;
    } else if (strcmp("version_minor", param_field) == 0) {
      version__minor().set_param(param);
      return;
    } else if (strcmp("statuscode", param_field) == 0) {
      statuscode().set_param(param);
      return;
    } else if (strcmp("statustext", param_field) == 0) {
      statustext().set_param(param);
      return;
      ...
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.HTTPResponse'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.HTTPResponse.");
...
boolean HTTPResponse_template::match(const HTTPResponse& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
if(!single_value->field_version__major.match(other_value.version__major()))return FALSE;
if(!other_value.version__minor().is_bound()) return FALSE;
if(!single_value->field_version__minor.match(other_value.version__minor()))return FALSE;
if(!other_value.statuscode().is_bound()) return FALSE;
if(!single_value->field_statuscode.match(other_value.statuscode()))return FALSE;
if(!other_value.statustext().is_bound()) return FALSE;
if(!single_value->field_statustext.match(other_value.statustext()))return FALSE;
...
if(!single_value->field_body.match(other_value.body()))return FALSE;
return TRUE;
case VALUE_LIST:
case COMPLEMENTED_LIST:
for (unsigned int list_count = 0; list_count < value_list.n_values; list_count++)
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.HTTPResponse.");
...
void HTTPResponse_template::log_match(const HTTPResponse& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
if(!single_value->field_version__major.match(match_value.version__major())){
TTCN_Logger::log_logmatch_info(".version_major");
single_value->field_version__major.log_match(match_value.version__major());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
if(!single_value->field_version__minor.match(match_value.version__minor())){
TTCN_Logger::log_logmatch_info(".version_minor");
single_value->field_version__minor.log_match(match_value.version__minor());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
if(!single_value->field_statuscode.match(match_value.statuscode())){
TTCN_Logger::log_logmatch_info(".statuscode");
single_value->field_statuscode.log_match(match_value.statuscode());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
if(!single_value->field_statustext.match(match_value.statustext())){
TTCN_Logger::log_logmatch_info(".statustext");
single_value->field_statustext.log_match(match_value.statustext());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
...
if(!single_value->field_body.match(match_value.body())){
...
void HTTPResponse_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.HTTPResponse'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
      ...
      body().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.HTTPResponse'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void HTTPResponse_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean HTTPResponse_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean HTTPResponse_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.HTTPRequest");
  int ret_val = 6;
  if (field_client__id.ispresent()) ret_val++;
  return ret_val;
}
...
void HTTPRequest::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.HTTPRequest'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
    } else if (strcmp("method", param_field) == 0) {
      method().set_param(param);
      return;
    } else if (strcmp("uri", param_field) == 0) {
      uri().set_param(param);
      return;
    } else if (strcmp("version_major", param_field) == 0) {
      version__major().set_param(param);
      ...
      body().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.HTTPRequest'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.HTTPRequest.");
field_client__id.encode_text(text_buf);
...
boolean HTTPRequest_template::match(const HTTPRequest& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
if(!single_value->field_method.match(other_value.method()))return FALSE;
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.HTTPRequest.");
HTTPRequest ret_val;
if (single_value->field_client__id.is_omit()) ret_val.client__id() = OMIT_VALUE;
else if (single_value->field_client__id.is_bound()) {
ret_val.client__id() = single_value->field_client__id.valueof();
...
void HTTPRequest_template::log_match(const HTTPRequest& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
if(!single_value->field_method.match(match_value.method())){
TTCN_Logger::log_logmatch_info(".method");
single_value->field_method.log_match(match_value.method());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
...
void HTTPRequest_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.HTTPRequest'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
      ...
      body().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.HTTPRequest'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void HTTPRequest_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean HTTPRequest_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean HTTPRequest_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.HTTPResponse_binary_body");
  int ret_val = 6;
  if (field_client__id.ispresent()) ret_val++;
  return ret_val;
}
...
void HTTPResponse__binary__body::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.HTTPResponse_binary_body'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
      ...
      body().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.HTTPResponse_binary_body'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.HTTPResponse_binary_body.");
field_client__id.encode_text(text_buf);
field_version__major.encode_text(text_buf);
field_version__minor.encode_text(text_buf);
field_statuscode.encode_text(text_buf);
...
boolean HTTPResponse__binary__body_template::match(const HTTPResponse__binary__body& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.HTTPResponse_binary_body.");
...
void HTTPResponse__binary__body_template::log_match(const HTTPResponse__binary__body& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
void HTTPResponse__binary__body_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.HTTPResponse_binary_body'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
      ...
      body().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.HTTPResponse_binary_body'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void HTTPResponse__binary__body_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean HTTPResponse__binary__body_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean HTTPResponse__binary__body_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.HTTPRequest_binary_body");
  int ret_val = 6;
  if (field_client__id.ispresent()) ret_val++;
  return ret_val;
}
...
void HTTPRequest__binary__body::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.HTTPRequest_binary_body'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
      ...
      body().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.HTTPRequest_binary_body'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.HTTPRequest_binary_body.");
field_client__id.encode_text(text_buf);
field_method.encode_text(text_buf);
field_uri.encode_text(text_buf);
field_version__major.encode_text(text_buf);
...
boolean HTTPRequest__binary__body_template::match(const HTTPRequest__binary__body& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.HTTPRequest_binary_body.");
...
void HTTPRequest__binary__body_template::log_match(const HTTPRequest__binary__body& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
void HTTPRequest__binary__body_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.HTTPRequest_binary_body'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
      ...
      body().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.HTTPRequest_binary_body'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void HTTPRequest__binary__body_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean HTTPRequest__binary__body_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean HTTPRequest__binary__body_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.HTTP_erronous_msg");
  int ret_val = 1;
  if (field_client__id.ispresent()) ret_val++;
  return ret_val;
}
...
void HTTP__erronous__msg::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.HTTP_erronous_msg'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
      ...
      msg().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.HTTP_erronous_msg'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.HTTP_erronous_msg.");
field_client__id.encode_text(text_buf);
...
boolean HTTP__erronous__msg_template::match(const HTTP__erronous__msg& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
if(!single_value->field_msg.match(other_value.msg()))return FALSE;
return TRUE;
case VALUE_LIST:
case COMPLEMENTED_LIST:
for (unsigned int list_count = 0; list_count < value_list.n_values; list_count++)
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.HTTP_erronous_msg.");
...
void HTTP__erronous__msg_template::log_match(const HTTP__erronous__msg& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
if(!single_value->field_msg.match(match_value.msg())){
TTCN_Logger::log_logmatch_info(".msg");
single_value->field_msg.log_match(match_value.msg());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
}else {
TTCN_Logger::print_logmatch_buffer();
...
void HTTP__erronous__msg_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.HTTP_erronous_msg'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
      ...
      msg().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.HTTP_erronous_msg'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void HTTP__erronous__msg_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean HTTP__erronous__msg_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean HTTP__erronous__msg_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
void HTTPMessage::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for union type `@HTTPmsg_Types.HTTPMessage'");
    }
    if (strcmp("response", param_field) == 0) {
      ...
      return;
    } else param.error("Field `%s' not found in union type `@HTTPmsg_Types.HTTPMessage'", param_field);
  }
...
boolean HTTPMessage_template::match(const HTTPMessage& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
case HTTPMessage::ALT_response:
return single_value.field_response->match(other_value.response());
case HTTPMessage::ALT_request:
return single_value.field_request->match(other_value.request());
case HTTPMessage::ALT_response__binary:
return single_value.field_response__binary->match(other_value.response__binary());
case HTTPMessage::ALT_request__binary:
return single_value.field_request__binary->match(other_value.request__binary());
case HTTPMessage::ALT_erronous__msg:
return single_value.field_erronous__msg->match(other_value.erronous__msg());
default:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of union type @HTTPmsg_Types.HTTPMessage.");
HTTPMessage ret_val;
switch (single_value.union_selection) {
case HTTPMessage::ALT_response:
...
void HTTPMessage_template::log_match(const HTTPMessage& match_value) const
{
...
single_value.field_response->log_match(match_value.response());
} else {
TTCN_Logger::log_event_str("{ response := ");
single_value.field_response->log_match(match_value.response());
TTCN_Logger::log_event_str(" }");
...
single_value.field_request->log_match(match_value.request());
} else {
TTCN_Logger::log_event_str("{ request := ");
single_value.field_request->log_match(match_value.request());
TTCN_Logger::log_event_str(" }");
...
single_value.field_response__binary->log_match(match_value.response__binary());
} else {
TTCN_Logger::log_event_str("{ response_binary := ");
single_value.field_response__binary->log_match(match_value.response__binary());
TTCN_Logger::log_event_str(" }");
...
single_value.field_request__binary->log_match(match_value.request__binary());
} else {
TTCN_Logger::log_event_str("{ request_binary := ");
single_value.field_request__binary->log_match(match_value.request__binary());
TTCN_Logger::log_event_str(" }");
...
single_value.field_erronous__msg->log_match(match_value.erronous__msg());
} else {
TTCN_Logger::log_event_str("{ erronous_msg := ");
single_value.field_erronous__msg->log_match(match_value.erronous__msg());
TTCN_Logger::log_event_str(" }");
...
boolean HTTPMessage_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean HTTPMessage_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
void HTTPMessage_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.Close");
  int ret_val = 0;
  if (field_client__id.ispresent()) ret_val++;
  return ret_val;
}
...
void Close::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.Close'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.Close'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.Close.");
field_client__id.encode_text(text_buf);
}
...
boolean Close_template::match(const Close& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.Close.");
Close ret_val;
if (single_value->field_client__id.is_omit()) ret_val.client__id() = OMIT_VALUE;
else if (single_value->field_client__id.is_bound()) {
ret_val.client__id() = single_value->field_client__id.valueof();
...
void Close_template::log_match(const Close& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
void Close_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.Close'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.Close'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void Close_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean Close_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean Close_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
int Connect::size_of() const
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.Connect");
  return 3;
}
...
void Connect::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.Connect'");
    }
    if (strcmp("hostname", param_field) == 0) {
      ...
      return;
    } else if (strcmp("use_ssl", param_field) == 0) {
      use__ssl().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.Connect'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.Connect.");
...
boolean Connect_template::match(const Connect& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
if(!single_value->field_use__ssl.match(other_value.use__ssl()))return FALSE;
return TRUE;
case VALUE_LIST:
case COMPLEMENTED_LIST:
for (unsigned int list_count = 0; list_count < value_list.n_values; list_count++)
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.Connect.");
Connect ret_val;
...
void Connect_template::log_match(const Connect& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
if(!single_value->field_use__ssl.match(match_value.use__ssl())){
TTCN_Logger::log_logmatch_info(".use_ssl");
single_value->field_use__ssl.log_match(match_value.use__ssl());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
}else {
TTCN_Logger::print_logmatch_buffer();
...
void Connect_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.Connect'");
    }
    if (strcmp("hostname", param_field) == 0) {
      hostname().set_param(param);
      return;
      ...
      use__ssl().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.Connect'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void Connect_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean Connect_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean Connect_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
int Connect__result::size_of() const
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.Connect_result");
  return 1;
}
...
void Connect__result::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.Connect_result'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.Connect_result'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.Connect_result.");
field_client__id.encode_text(text_buf);
}
...
boolean Connect__result_template::match(const Connect__result& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.Connect_result.");
...
void Connect__result_template::log_match(const Connect__result& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
void Connect__result_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.Connect_result'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.Connect_result'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void Connect__result_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean Connect__result_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean Connect__result_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
int Client__connected::size_of() const
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.Client_connected");
  return 3;
}
...
void Client__connected::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.Client_connected'");
    }
    if (strcmp("hostname", param_field) == 0) {
      hostname().set_param(param);
      return;
      ...
      client__id().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.Client_connected'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.Client_connected.");
field_hostname.encode_text(text_buf);
field_portnumber.encode_text(text_buf);
field_client__id.encode_text(text_buf);
}
...
boolean Client__connected_template::match(const Client__connected& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.Client_connected.");
...
void Client__connected_template::log_match(const Client__connected& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
void Client__connected_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.Client_connected'");
    }
    if (strcmp("hostname", param_field) == 0) {
      hostname().set_param(param);
      return;
      ...
      client__id().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.Client_connected'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void Client__connected_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean Client__connected_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean Client__connected_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.Half_close");
  int ret_val = 0;
  if (field_client__id.ispresent()) ret_val++;
  return ret_val;
}
...
void Half__close::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.Half_close'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.Half_close'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.Half_close.");
field_client__id.encode_text(text_buf);
}
...
boolean Half__close_template::match(const Half__close& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.Half_close.");
Half__close ret_val;
if (single_value->field_client__id.is_omit()) ret_val.client__id() = OMIT_VALUE;
else if (single_value->field_client__id.is_bound()) {
ret_val.client__id() = single_value->field_client__id.valueof();
...
void Half__close_template::log_match(const Half__close& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
void Half__close_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.Half_close'");
    }
    if (strcmp("client_id", param_field) == 0) {
      client__id().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.Half_close'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void Half__close_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean Half__close_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean Half__close_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.Listen");
  int ret_val = 2;
...
void Listen::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.Listen'");
    }
    if (strcmp("local_hostname", param_field) == 0) {
      ...
      use__ssl().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.Listen'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.Listen.");
...
boolean Listen_template::match(const Listen& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.Listen.");
Listen ret_val;
...
void Listen_template::log_match(const Listen& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
void Listen_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.Listen'");
    }
    if (strcmp("local_hostname", param_field) == 0) {
      local__hostname().set_param(param);
      return;
      ...
      use__ssl().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.Listen'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void Listen_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean Listen_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean Listen_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
int Listen__result::size_of() const
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @HTTPmsg_Types.Listen_result");
  return 1;
}
...
void Listen__result::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@HTTPmsg_Types.Listen_result'");
    }
    if (strcmp("portnumber", param_field) == 0) {
      portnumber().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@HTTPmsg_Types.Listen_result'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  switch (param.get_type()) {
  case Module_Param::MP_Value_List:
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @HTTPmsg_Types.Listen_result.");
field_portnumber.encode_text(text_buf);
}
...
boolean Listen__result_template::match(const Listen__result& other_value) const
{
if (!other_value.is_bound()) return FALSE;
switch (template_selection) {
case ANY_VALUE:
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @HTTPmsg_Types.Listen_result.");
...
void Listen__result_template::log_match(const Listen__result& match_value) const
{
if(TTCN_Logger::VERBOSITY_COMPACT == TTCN_Logger::get_matching_verbosity()){
if(match(match_value)){
TTCN_Logger::print_logmatch_buffer();
...
void Listen__result_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@HTTPmsg_Types.Listen_result'");
    }
    if (strcmp("portnumber", param_field) == 0) {
      portnumber().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@HTTPmsg_Types.Listen_result'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  switch (param.get_type()) {
  case Module_Param::MP_Omit:
...
void Listen__result_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean Listen__result_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean Listen__result_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
void Shutdown::set_param(const Module_Param& param)
{
...
boolean Shutdown_template::match(null_type other_value) const
{
switch (template_selection) {
case ANY_VALUE:
case ANY_OR_OMIT:
...
boolean Shutdown_template::match(const Shutdown& other_value) const
{
...
void Shutdown_template::log_match(const Shutdown& match_value) const
{
match_value.log();
TTCN_Logger::log_event_str(" with ");
log();
...
void Shutdown_template::set_param(const Module_Param& param)
{
...
void Shutdown_template::check_restriction(template_res t_res, const char* t_name) const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return;
switch ((t_name&&(t_res==TR_VALUE))?TR_OMIT:t_res) {
case TR_OMIT:
...
boolean Shutdown_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean Shutdown_template::match_omit() const
{
if (is_ifpresent) return TRUE;
switch (template_selection) {
case OMIT_VALUE:
...
static void pre_init_module()
{
/* /work/TDT4290/src/http/test_ports/HTTPmsg_Types.ttcn, line 25 */
modulepar_tsp__socket__debugging = FALSE;
/* /work/TDT4290/src/http/test_ports/HTTPmsg_Types.ttcn, line 26 */
