...
const XERdescriptor_t       Bad__request_xer_ = { {"Bad_request>\n", "bad-request>\n"}, {13, 13}, 0, WHITESPACE_PRESERVE,  NULL, &module_object, 9, 0, NULL, NULL };
...
const XERdescriptor_t       StanzaErrorGroup_xer_ = { {"StanzaErrorGroup>\n", "StanzaErrorGroup>\n"}, {18, 18}, 0 |UNTAGGED, WHITESPACE_PRESERVE,  NULL, &module_object, 9, 0, NULL, NULL };
...
static const namespace_t xml_namespaces[num_namespaces+1] = {
  ...
  { NULL, NULL },
  { NULL, NULL },
  { "urn:ietf:params:xml:ns:xmpp-stanzas", "tq0006" },
  { NULL, NULL },
  { NULL, NULL },
  { NULL, NULL },
  { NULL, NULL },
