...
class AnyType_elem__list;
class AnyType_elem__list_template;
class AnyType;
...
class AnyType_elem__list : public Base_Type {
...
private:
friend boolean operator==(null_type null_value, const AnyType_elem__list& other_value);

public:
  typedef UNIVERSAL_CHARSTRING of_type;
AnyType_elem__list();
AnyType_elem__list(null_type other_value);
AnyType_elem__list(const AnyType_elem__list& other_value);
~AnyType_elem__list();

void clean_up();
AnyType_elem__list& operator=(null_type other_value);
AnyType_elem__list& operator=(const AnyType_elem__list& other_value);

boolean operator==(null_type other_value) const;
boolean operator==(const AnyType_elem__list& other_value) const;
inline boolean operator!=(null_type other_value) const { return !(*this == other_value); }
inline boolean operator!=(const AnyType_elem__list& other_value) const { return !(*this == other_value); }
...
AnyType_elem__list operator<<=(int rotate_count) const;
AnyType_elem__list operator<<=(const INTEGER& rotate_count) const;
AnyType_elem__list operator>>=(int rotate_count) const;
AnyType_elem__list operator>>=(const INTEGER& rotate_count) const;

AnyType_elem__list operator+(const AnyType_elem__list& other_value) const;

AnyType_elem__list substr(int index, int returncount) const;

AnyType_elem__list replace(int index, int len, const AnyType_elem__list& repl) const;

AnyType_elem__list replace(int index, int len, const AnyType_elem__list_template& repl) const;
...
class AnyType_elem__list_template : public Record_Of_Template {
union {
struct {
int n_elements;
...
AnyType_elem__list_template *list_value;
} value_list;
};
void copy_value(const AnyType_elem__list& other_value);
void copy_template(const AnyType_elem__list_template& other_value);
...
public:
AnyType_elem__list_template();
AnyType_elem__list_template(template_sel other_value);
AnyType_elem__list_template(null_type other_value);
AnyType_elem__list_template(const AnyType_elem__list& other_value);
AnyType_elem__list_template(const OPTIONAL<AnyType_elem__list>& other_value);
AnyType_elem__list_template(const AnyType_elem__list_template& other_value);
~AnyType_elem__list_template();

void clean_up();
AnyType_elem__list_template& operator=(template_sel other_value);
AnyType_elem__list_template& operator=(null_type other_value);
AnyType_elem__list_template& operator=(const AnyType_elem__list& other_value);
AnyType_elem__list_template& operator=(const OPTIONAL<AnyType_elem__list>& other_value);
AnyType_elem__list_template& operator=(const AnyType_elem__list_template& other_value);
...
boolean match(const AnyType_elem__list& other_value) const;
inline boolean is_bound() const 
  {return template_selection != UNINITIALIZED_TEMPLATE; }
boolean is_value() const;
AnyType_elem__list valueof() const;
AnyType_elem__list substr(int index, int returncount) const;
...
AnyType_elem__list_template& list_item(unsigned int list_index);
void log() const;
void log_match(const AnyType_elem__list& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
...
class AnyType : public Base_Type {
  AnyType_attr field_attr;
  AnyType_elem__list field_elem__list;
  boolean bound_flag;
public:
  AnyType();
  AnyType(const AnyType_attr& par_attr,
...
inline boolean is_present() const { return is_bound(); }
  ...
  inline AnyType_attr& attr()
    {return field_attr;}
  inline const AnyType_attr& attr() const
    {return field_attr;}
...
boolean match(const AnyType& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
...
int size_of() const;
void log() const;
void log_match(const AnyType& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
boolean match(const QName& other_value) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
QName valueof() const;
...
int size_of() const;
void log() const;
void log_match(const QName& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL) const;
...
extern boolean operator==(null_type null_value, const AnyType_elem__list& other_value);
inline boolean operator!=(null_type null_value, const AnyType_elem__list& other_value) { return !(null_value == other_value); }
