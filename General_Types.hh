...
boolean match(const Integer__array& other_value) const;
...
void log() const;
void log_match(const Integer__array& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
...
boolean match(Protocols::enum_type other_value) const;
boolean match(const Protocols& other_value) const;
Protocols::enum_type valueof() const;
void set_type(template_sel template_type, unsigned int list_length);
Protocols_template& list_item(unsigned int list_index);
void log() const;
void log_match(const Protocols& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
boolean is_present() const;
boolean match_omit() const;
...
inline int size_of() const { return size_of(TRUE); }
inline int lengthof() const { return size_of(FALSE); }
boolean match(const ListOfDummy__comptype& other_value) const;
inline boolean is_bound() const 
  {return template_selection != UNINITIALIZED_TEMPLATE; }
boolean is_value() const;
...
void log() const;
void log_match(const ListOfDummy__comptype& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
boolean is_present() const;
boolean match_omit() const;
...
inline int size_of() const { return size_of(TRUE); }
inline int lengthof() const { return size_of(FALSE); }
boolean match(const ListOfDummy__CT& other_value) const;
inline boolean is_bound() const 
  {return template_selection != UNINITIALIZED_TEMPLATE; }
boolean is_value() const;
...
void log() const;
void log_match(const ListOfDummy__CT& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
boolean is_present() const;
boolean match_omit() const;
...
inline int size_of() const { return size_of(TRUE); }
inline int lengthof() const { return size_of(FALSE); }
boolean match(const ProtocolList& other_value) const;
inline boolean is_bound() const 
  {return template_selection != UNINITIALIZED_TEMPLATE; }
boolean is_value() const;
...
void log() const;
void log_match(const ProtocolList& match_value) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
boolean is_present() const;
boolean match_omit() const;
...
extern const TTCN_JSONdescriptor_t Integers_json_;
...
extern const TTCN_JSONdescriptor_t Integer__array_json_;
...
extern const TTCN_JSONdescriptor_t Protocols_json_;
extern const TTCN_Typedescriptor_t Protocols_descr_;
extern const TTCN_RAWdescriptor_t OCT1List_raw_;
extern const TTCN_JSONdescriptor_t OCT1List_json_;
...
extern const TTCN_JSONdescriptor_t OCT2List_json_;
...
extern const TTCN_JSONdescriptor_t OCT3List_json_;
...
extern const TTCN_JSONdescriptor_t OCT4List_json_;
...
extern const TTCN_JSONdescriptor_t OCT5List_json_;
...
extern const TTCN_JSONdescriptor_t OCT6List_json_;
...
extern const TTCN_JSONdescriptor_t OCT7List_json_;
...
extern const TTCN_JSONdescriptor_t ProtocolList_json_;
