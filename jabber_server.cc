...
const XERdescriptor_t       Priority_xer_ = { {"Priority>\n", "priority>\n"}, {10, 10}, 0, WHITESPACE_PRESERVE, &Priority_dfe, &module_object, 10, 0, NULL, NULL };
...
const XERdescriptor_t       Presence_choice__list_0_priority_xer_ = { {"priority>\n", "priority>\n"}, {10, 10}, 0, WHITESPACE_PRESERVE, &Presence_choice__list_0_priority_dfe, &module_object, 10, 0, NULL, NULL };
