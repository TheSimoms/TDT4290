...
#ifndef CharstringInputPortType_HH
#define CharstringInputPortType_HH

#include "CoffeeSuite.hh"

namespace CoffeeSuite {

class CharstringInputPortType : public CharstringInputPortType_BASE {
public:
	CharstringInputPortType(const char *par_port_name = NULL);
