...
const TTCN_RAWdescriptor_t byte_raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t unsignedbyte_raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t short__raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t unsignedshort_raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t long__raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t unsignedlong_raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t longlong_raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t unsignedlonglong_raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t IEEE754float_raw_ = {64,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t IEEE754double_raw_ = {64,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t IEEE754extfloat_raw_ = {64,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t IEEE754extdouble_raw_ = {64,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t utf8string_raw_ = {0,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t bmpstring_raw_ = {0,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t utf16string_raw_ = {0,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t iso8859string_raw_ = {0,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t IDLfixed_raw_ = {0,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
const XERdescriptor_t       IDLfixed_xer_ = { {"IDLfixed>\n", "IDLfixed>\n"}, {10, 10}, 0 |FORM_UNQUALIFIED, WHITESPACE_PRESERVE,  NULL, &module_object, -1, 0, NULL, NULL };
const TTCN_JSONdescriptor_t IDLfixed_json_ = { false, NULL, false, NULL };
...
const TTCN_Typedescriptor_t uchar_descr_ = { "@UsefulTtcn3Types.uchar", NULL, NULL, &UNIVERSAL_CHARSTRING_text_, &uchar_xer_, &UNIVERSAL_CHARSTRING_json_, NULL, TTCN_Typedescriptor_t::DONTCARE };
const TTCN_RAWdescriptor_t bit_raw_ = {1,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t hex_raw_ = {4,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
const TTCN_RAWdescriptor_t octet_raw_ = {8,SG_NO,ORDER_LSB,ORDER_LSB,ORDER_LSB,ORDER_LSB,EXT_BIT_NO,ORDER_LSB,ORDER_LSB,TOP_BIT_INHERITED,0,0,0,8,0,NULL,-1};
...
TTCN_Module module_object("UsefulTtcn3Types", __DATE__, __TIME__, module_checksum, NULL, NULL, 0U, 4294967295U, 4294967295U, 4294967295U, NULL, 21LU, xml_namespaces, NULL, NULL, NULL, NULL, NULL, NULL);
...
int IDLfixed::size_of() const
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @UsefulTtcn3Types.IDLfixed");
  return 3;
}
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@UsefulTtcn3Types.IDLfixed'");
    }
    if (strcmp("digits", param_field) == 0) {
      digits().set_param(param);
      return;
    } else if (strcmp("scale", param_field) == 0) {
      scale().set_param(param);
      return;
    } else if (strcmp("value_", param_field) == 0) {
      value__().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@UsefulTtcn3Types.IDLfixed'", param_field);
  }
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @UsefulTtcn3Types.IDLfixed.");
...
char ** IDLfixed::collect_ns(const XERdescriptor_t& p_td, size_t& num_ns, bool& def_ns) const {
  ...
  size_t num_new;
  bool def_ns_1 = false;
  new_ns = field_digits.collect_ns(IDLfixed_digits_xer_, num_new, def_ns);
  merge_ns(collected_ns, num_collected, new_ns, num_new);
  def_ns = def_ns || def_ns_1;
  new_ns = field_scale.collect_ns(IDLfixed_scale_xer_, num_new, def_ns);
  merge_ns(collected_ns, num_collected, new_ns, num_new);
  def_ns = def_ns || def_ns_1;
  new_ns = field_value__.collect_ns(IDLfixed_value___xer_, num_new, def_ns);
  merge_ns(collected_ns, num_collected, new_ns, num_new);
  def_ns = def_ns || def_ns_1;
  }
  catch (...) {
...
boolean IDLfixed::can_start(const char *name, const char *uri, const XERdescriptor_t& xd, unsigned int flavor) {
  ...
  else if (INTEGER::can_start(name, uri, IDLfixed_digits_xer_, flavor)) return true;
  return false;
}

int IDLfixed::XER_encode(const XERdescriptor_t& p_td, TTCN_Buffer& p_buf, unsigned int p_flavor, int p_indent, embed_values_enc_struct_t*) const
{
  if (!is_bound()) TTCN_EncDec_ErrorContext::error(TTCN_EncDec::ET_UNBOUND, "Encoding an unbound value.");
  ...
  ec_1.set_msg("digits': ");
  sub_len += field_digits.XER_encode(IDLfixed_digits_xer_, p_buf, p_flavor, p_indent+!omit_tag, 0);
  ec_1.set_msg("scale': ");
  sub_len += field_scale.XER_encode(IDLfixed_scale_xer_, p_buf, p_flavor, p_indent+!omit_tag, 0);
  ec_1.set_msg("value_': ");
  sub_len += field_value__.XER_encode(IDLfixed_value___xer_, p_buf, p_flavor, p_indent+!omit_tag, 0);
  } // QN?
  if (!omit_tag) {
  if (sub_len) {
...
int IDLfixed::XER_decode(const XERdescriptor_t& p_td, XmlReaderWrap& p_reader, unsigned int p_flavor, embed_values_dec_struct_t*)
{
  bound_flag = TRUE;
  int e_xer = is_exer(p_flavor);
  ...
  {
    ec_1.set_msg("digits': ");
    field_digits.XER_decode(IDLfixed_digits_xer_, p_reader, p_flavor | (p_td.xer_bits & USE_NIL)| (tag_closed ? PARENT_CLOSED : 0), 0);
  }
  {
    ec_1.set_msg("scale': ");
    field_scale.XER_decode(IDLfixed_scale_xer_, p_reader, p_flavor | (p_td.xer_bits & USE_NIL)| (tag_closed ? PARENT_CLOSED : 0), 0);
  }
  if (e_xer && p_td.dfeValue && p_reader.IsEmptyElement()) {
    ...
    ec_1.set_msg("value_': ");
    field_value__.XER_decode(IDLfixed_value___xer_, p_reader, p_flavor | (p_td.xer_bits & USE_NIL)| (tag_closed ? PARENT_CLOSED : 0), 0);
  }
  } // errorcontext
  if (!omit_tag) {
    int current_depth;
...
int IDLfixed::JSON_encode(const TTCN_Typedescriptor_t&, JSON_Tokenizer& p_tok) const
{
  if (!is_bound()) {
...
int IDLfixed::JSON_decode(const TTCN_Typedescriptor_t&, JSON_Tokenizer& p_tok, boolean p_silent)
{
      ...
      if (6 == name_len && 0 == strncmp(fld_name, "digits", name_len)) {
        ...
        if (0 > ret_val) {
          if (JSON_ERROR_INVALID_TOKEN) {
            JSON_ERROR(TTCN_EncDec::ET_INVAL_MSG, JSON_DEC_FIELD_TOKEN_ERROR, "digits");
          }
          return JSON_ERROR_FATAL;
        }
        dec_len += ret_val;
        ...
        if (0 > ret_val) {
          if (JSON_ERROR_INVALID_TOKEN) {
            JSON_ERROR(TTCN_EncDec::ET_INVAL_MSG, JSON_DEC_FIELD_TOKEN_ERROR, "scale");
          }
          return JSON_ERROR_FATAL;
        }
        dec_len += ret_val;
...
boolean IDLfixed_template::match(const IDLfixed& other_value) const
{
...
if(!single_value->field_digits.match(other_value.digits()))return FALSE;
if(!other_value.scale().is_bound()) return FALSE;
if(!single_value->field_scale.match(other_value.scale()))return FALSE;
...
TTCN_error("Performing valueof or send operation on a non-specific template of type @UsefulTtcn3Types.IDLfixed.");
IDLfixed ret_val;
...
void IDLfixed_template::log_match(const IDLfixed& match_value) const
{
...
if(!single_value->field_digits.match(match_value.digits())){
TTCN_Logger::log_logmatch_info(".digits");
single_value->field_digits.log_match(match_value.digits());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
if(!single_value->field_scale.match(match_value.scale())){
TTCN_Logger::log_logmatch_info(".scale");
single_value->field_scale.log_match(match_value.scale());
TTCN_Logger::set_logmatch_buffer_len(previous_size);
}
...
void IDLfixed_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@UsefulTtcn3Types.IDLfixed'");
    }
    if (strcmp("digits", param_field) == 0) {
      digits().set_param(param);
      return;
      ...
      value__().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@UsefulTtcn3Types.IDLfixed'", param_field);
  }
...
void IDLfixed_template::check_restriction(template_res t_res, const char* t_name) const
{
...
boolean IDLfixed_template::is_present() const
{
if (template_selection==UNINITIALIZED_TEMPLATE) return FALSE;
return !match_omit();
}

boolean IDLfixed_template::match_omit() const
{
